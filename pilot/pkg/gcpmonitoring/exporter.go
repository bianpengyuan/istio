...
var (
	trustDomain     = ""
	podNameVar      = env.RegisterStringVar("POD_NAME", "unknown", "istiod pod name, specified by GCP profile.")
	podNamespaceVar = env.RegisterStringVar("POD_NAMESPACE", "istio-system", "istiod pod namespace, specified by GCP profile.")
	meshIDVar       = env.RegisterStringVar("MESH_ID", "", "mesh id, specified by GCP profile.")
)
