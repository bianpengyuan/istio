...
_sym_db.RegisterEnumDescriptor(_AUTHENTICATION_MODE)
...
_CONNECTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='authentication', full_name='istio.policy.v1beta1.Connection.authentication', index=1,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_AUTHENTICATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='mode', full_name='istio.policy.v1beta1.Authentication.mode', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='basic_auth_token', full_name='istio.policy.v1beta1.Authentication.basic_auth_token', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='private_key', full_name='istio.policy.v1beta1.Authentication.private_key', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='client_certificate', full_name='istio.policy.v1beta1.Authentication.client_certificate', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ca_cerficates', full_name='istio.policy.v1beta1.Authentication.ca_cerficates', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='subject_identity', full_name='istio.policy.v1beta1.Authentication.subject_identity', index=5,
...
_AUTHENTICATION.fields_by_name['mode'].enum_type = _AUTHENTICATION_MODE
_AUTHENTICATION_MODE.containing_type = _AUTHENTICATION
