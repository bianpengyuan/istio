...
// NewListcheckerNoSessionServer creates a new no session server from given args.
func NewListcheckerNoSessionServer(addr uint16, poolSize int) (*NoSession, error) {
