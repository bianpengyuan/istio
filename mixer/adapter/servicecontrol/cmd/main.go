...
import (
	...
	"istio.io/istio/mixer/adapter/servicecontrol/cmd/server"
)
...
func GetCmd(args []string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "servicecontrol",
		Short: "servicecontrol out of process adapter.",
...
func runServer(args *Args) {
	s, err := server.NewServicecontrolNoSessionServer(args.AdapterPort, args.APIWorkerPoolSize)
	if err != nil {
