...
// NewPrometheusNoSessionServer creates a new no session server from given args.
func NewPrometheusNoSessionServer(addr uint16, poolSize int) (*NoSession, error) {
