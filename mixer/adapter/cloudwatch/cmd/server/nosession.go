...
// NewCloudwatchNoSessionServer creates a new no session server from given args.
func NewCloudwatchNoSessionServer(addr uint16, poolSize int) (*NoSession, error) {
