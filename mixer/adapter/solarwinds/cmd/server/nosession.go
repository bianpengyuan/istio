...
// NewSolarwindsNoSessionServer creates a new no session server from given args.
func NewSolarwindsNoSessionServer(addr uint16, poolSize int) (*NoSession, error) {
